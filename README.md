...
3. A host machine of your choice with x86_64 architecture (the host used for this setup was an Ubuntu server edition 14.04 x86_64)
...
4. launch the container : `docker run -it -d -p 28960:28960/udp -p 20510:20510/udp -v /path/to/cod2server:/home/cod2/cod2server cod2server`. Don't forget to update the path of the `cod2server` folder in the docker command to fit your configuration. Depending on your setup, you might have some port-forwarding to do.
